...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_paired', type=float, default=10, help='Weight for paired loss')
        ...
        self.parser.add_argument('--deca_root', type=str, default='./MEAD_data', help='Directory containing (reconstructed) MEAD')
        ...
        self.parser.add_argument('--celeb', type=str, default='./celebrities', help='Directory containing test and reference celebrities')
        ...
        self.parser.add_argument('--encoder_ckpt', type=str, help='expr encoder and scale layer checkpoint', default=None)
